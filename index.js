...
* (Scriptnya RIDHO).
*/
const BotName = '🤖BISTRO BOT🤖'; // Nama Bot Whatsapp
const instagramlu = 'ajhialfarid'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/+62895619811574'; // Nomor whatsapplu cok
...
conn.sendMessage(id, 'Owner BISTRO BOT  https://Wa.me/+62895619811574' ,MessageType.text);
}
else if (text == 'BISTRO'){
conn.sendMessage(id, 'Aku BOT nya RIDHO' ,MessageType.text);
}
...
conn.sendMessage(id, 'coba lu comand #randomhentai' ,MessageType.text);
}
...
//Tolonglah bro jangan di ubah ubah scripnya ya kecuali di bangian pagar untuk memanggil si program contoh #menu\ itu bisa di ganti ya
